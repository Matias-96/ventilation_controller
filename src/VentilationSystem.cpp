...
VentilationSystem::VentilationSystem(VentilationFan *_fan,
		SDP610 *_pressure_sensor, bool _auto_mode, int _target_pressure) :
		fan(_fan), pressure_sensor(_pressure_sensor), auto_mode(_auto_mode), target_pressure(
				_target_pressure), fan_speed(0), error_codes(0), counter(0) {
